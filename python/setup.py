...
setup(
    ...
    name="rigid_body_dynamics",  # Required
    ...
    url="https://github.com/pvarin/rigid-body-dynamics",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Patrick Varin",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="patrickvarin@gmail.com",  # Optional
    ...
    install_requires=["attrs==19.3.0", "numpy==1.18.1"],  # Optional
    ...
    project_urls={  # Optional
        "Bug Reports": "https://github.com/pvarin/rigid-body-dynamics/issues",
        "Source": "https://github.com/pvarin/rigid-body-dynamics/",
    },
)
